...
const musica = new Audio('./sons/luna-rise-part-one.ogg')
const iniciarOuPausarBt = document.querySelector('#start-pause span')
const iconeIniciarOuPausarBt = document.querySelector('.app__card-primary-butto-icon')
const pause = new Audio('./sons/pause.ogg')
const playContagem = new Audio('./sons/play.ogg')
const finalizarContagem = new Audio('./sons/beep.ogg')
